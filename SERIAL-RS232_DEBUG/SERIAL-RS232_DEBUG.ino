...
OK  em 27/05/24   V1.1  Teste de recepção de dados porta serial 232
...
EM execução       V1.12 Leitura de comandos enviados pelo software
                  ...
                  V1.2  Teste de protocolo via rede 485
                  V1.3  Teste de protocolo conversor ethernet
                  V1.4  Teste de protocolo conversor ethernet com assistência via PLC
                  V1.5  Auxiliar na automação mecânica do processo de coleta de grãos
                  V1.6  Versão física de apresentação de funções mínimas
                  V1.7  Utilizar conversor RS232/ porta serial.
...
byte msg_boot5[] = {    0x0D,    0x50,    0x43,    0x6F,    0x6E,    0x65,    0x78,    0x61,
                        0x6F,    0x20,    0x63,    0x6F,    0x61,    0x20};
...
byte msg_bot47[] = {    0x0D,    0x50,    0x41,    0x6E,    0x61,    0x6C,
                        0x69,    0x73,    0x61,    0x72,    0x20,    0x55,
                        0x6D,    0x69,    0x64,    0x61,    0x64,    0x65};
byte msg_bot48[] = {    0x0D,    0x30,    0x0F,    0x1B,    0x06,    
                        0x06,    0x18};

...
// PROCESSO MILHO
  ...
  byte msg_milho007[] = {0x0D, 0x30, 0x0C, 0x23, 0x0A, 0x06, 0x18};  
...
LEITURA DAS RESPOSTAS DO APARELHO
...
/*
  ...
  byte msg_milho001[] = {0x0D, 0x42};  // 1,8 SEGUNDOS
  byte msg_milho002[] = {0x0D, 0x50, 0x49, 0x44, 0x3A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20}; // 75MS
  byte msg_milho003[] = {0x0D, 0x50, 0x45, 0x73, 0x76, 0x61, 0x7A, 0x69, 0x61, 0x72, 0x20, 0x6F, 0x20, 0x63, 0x6F, 0x70, 0x6F, 0x20}; // 2SEG
  byte msg_milho004[] = {0x0D, 0x44};  // 129MS
  byte msg_milho005[] = {0x0D, 0x57};  //  72MS
  byte msg_milho006[] = {0x0D, 0x45};  //  72MS
  byte msg_milho007[] = {0x0D, 0x30, 0x0C, 0x23, 0x0A, 0x06, 0x18}; // 1 SEG
  byte msg_milho008[] = {0x0D, 0x50, 0x43, 0x61, 0x6C, 0x69, 0x62, 0x2E, 0x20, 0x61, 0x20, 0x62, 0x61, 0x6C, 0x61, 0x6E, 0x63, 0x61}; // 12MS
  byte msg_milho009[] = {0x0D, 0x49};  //  48MS
  byte msg_milho010[] = {0x0D, 0x4C};  //  150MS
  byte msg_milho011[] = {0x0D, 0x46};  //   36MS  6x
  //{0x0D, 0x46};  //   95MS
  byte msg_milho013[] = {0x0D, 0x48};  //   1,6SEG
  //{0x0D, 0x49};  //   550MS
  byte msg_milho015[] = {0x0D, 0x47};  //    38MS 4x
  //{0x0D, 0x48};  //   806MS
  byte msg_milho017[] = {0x0D, 0x4A};  //   149MS
  //{0x0D, 0x47};  //    29MS 4x
  //{0x0D, 0x4C};  //   100MS
  //{0x0D, 0x48};  //   100MS
  //{0x0D, 0x47};  //    29MS 4x
  //{0x0D, 0x4C};  //    48MS 
  //{0x0D, 0x49};  //    1,32 SEG
  byte msg_milho024[] = {0x0D, 0x50, 0x45, 0x6E, 0x63, 0x68, 0x65, 0x72, 0x2C, 0x74, 0x69, 0x72, 0x61, 0x72, 0x20, 0x65, 0x78, 0x63}; // 102MS
  //{0x0D, 0x46};  //    40MS 
  ...
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho032[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x20, 0x32, 0x31, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho037[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x20, 0x37, 0x37, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho038[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x31, 0x34, 0x35, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho039[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x31, 0x39, 0x31, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho040[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x32, 0x35, 0x32, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho041[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x30, 0x37, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho042[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x34, 0x38, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho043[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x35, 0x39, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho044[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x36, 0x33, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho045[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x35, 0x39, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho046[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x36, 0x30, 0x20, 0x67, 0x72, 0x2E}; // 58MS
  //{0x0D, 0x46};  //    40MS 7 VEZES!!!
  //{0x0D, 0x46};  //    74MS
  //{0x0D, 0x57};  //    80MS
  //{0x0D, 0x45};  //   130MS
  byte msg_milho047[] = {0x0D, 0x50, 0x50, 0x65, 0x73, 0x6F, 0x20, 0x3D, 0x20, 0x20, 0x20, 0x33, 0x36, 0x30, 0x20, 0x67, 0x72, 0x2E}; // 61MS
  byte msg_milho048[] = {0x0D, 0x50, 0x20, 0x50, 0x72, 0x6F, 0x63, 0x65, 0x73, 0x73, 0x61, 0x6E, 0x64, 0x6F, 0x21, 0x21, 0x21, 0x20}; //110MS
  //{0x0D, 0x48};  //   1,2 SEG
  //{0x0D, 0x49};  // 550MS
  //{0x0D, 0x47};  //    3 VEZES 30MS
  //{0x0D, 0x47};  //    80MS
  //{0x0D, 0x48};  //    100MS
  //{0x0D, 0x4A};  //    148MS
  //{0x0D, 0x47};  //    4 VEZES 30MS
  //{0x0D, 0x4C};  //    98MS
  byte msg_milho057[] = {0x0D, 0x4B};  //   100MS
  //{0x0D, 0x47};  //    4 VEZES 30MS
  //{0x0D, 0x4C};  //    50MS
  //{0x0D, 0x49};  //    100MS
  //{0x0D, 0x46};  //    45MS 7x
  ...
  //{0x0D, 0x57};  //    127MS
  //{0x0D, 0x57};  //    125MS
  byte msg_milho065[] = {0x0D, 0x50, 0x4D, 0x65, 0x64, 0x69, 0x6E, 0x64, 0x6F, 0x20, 0x74, 0x65, 0x6D, 0x70, 0x2E, 0x20, 0x20, 0x20}; //60MS
  //{0x0D, 0x45};  //    230MS 6X
  //{0x0D, 0x45};  //    850MS  
  //{0x0D, 0x45};  //    230MS 3X
  //{0x0D, 0x45};  //    850MS  
  ...
  //{0x0D, 0x45};  //    850MS 
  //{0x0D, 0x42};  //    28MS
  byte msg_milho068[] = {0x0D, 0x50, 0x20, 0x55, 0x6D, 0x69, 0x64, 0x61, 0x64, 0x65, 0x20, 0x20, 0x39, 0x2E, 0x36, 0x20, 0x25, 0x20}; //1.9SEG
  //{0x0D, 0x44};  //    127MS
  //{0x0D, 0x57};  //    74MS
  //{0x0D, 0x45};  //    77MS
  byte msg_milho071[] = {0x0D, 0x30, 0x0C, 0x24, 0x0A, 0x06, 0x18}; //1,7 SEG
  //{0x0D, 0x44};  //    127MS
  //{0x0D, 0x57};  //    74MS
  //{0x0D, 0x45};  //    77MS
  //{0x0D, 0x30, 0x0C, 0x24, 0x0A, 0x06, 0x18}; //1 SEG
  byte msg_milho074[] = {0x0D, 0x50, 0x49, 0x44, 0x3A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20}; //45MS
  byte msg_milho075[] = {0x0D, 0x50, 0x41, 0x6E, 0x61, 0x6C, 0x69, 0x73, 0x61, 0x72, 0x20, 0x55, 0x6D, 0x69, 0x64, 0x61, 0x64, 0x65}; //2SEG
  //{0x0D, 0x44};  //    127MS
  //{0x0D, 0x57};  //    74MS
  //{0x0D, 0x45};  //    77MS
  //{0x0D, 0x30, 0x0C, 0x24, 0x0A, 0x06, 0x18}; //1 SEG
